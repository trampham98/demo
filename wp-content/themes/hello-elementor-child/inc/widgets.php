 ...
 */
add_filter( 'dynamic_sidebar_params', 'maddie_widget_classes' );

if ( ! function_exists( 'maddie_widget_classes' ) ) {
	 ...
	 * @return array $params
	 */
	function maddie_widget_classes( $params ) {
...
add_action( 'widgets_init', 'maddie_widgets_init' );

if ( ! function_exists( 'maddie_widgets_init' ) ) {
	/**
	 * Initializes themes widgets.
	 */
	function maddie_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'maddie' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'maddie' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'maddie' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'maddie' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Widget', 'maddie' ),
				'id'            => 'statichero',
				'description'   => __( 'Footer widget with dynamic grid', 'maddie' ),
		...
		// register_sidebar(
		// 	array(
		// 		'name'          => __( 'Footer Full', 'maddie' ),
		// 		'id'            => 'footerfull',
		// 		'description'   => __( 'Full sized footer widget with dynamic grid', 'maddie' ),
...
} // End of function_exists( 'maddie_widgets_init' ).
