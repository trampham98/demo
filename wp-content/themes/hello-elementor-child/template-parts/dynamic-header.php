...
?>
<header id="site-header" class="md-header site-header dynamic-header <?php echo esc_attr( hello_get_header_layout_class() ); ?>" role="banner">
	<div class="header-inner">
		...
		<?php if ( $header_nav_menu ) : ?>
			<nav class="site-navigation maddie-main-nav <?php echo hello_show_or_hide( 'hello_header_menu_display' ); ?>" role="navigation">
